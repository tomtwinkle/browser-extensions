...
const MESSAGES = {
  en: {
    ...
    labelWhisperModel:     'Whisper model',
    optWhisperTiny:        'tiny (fastest, low accuracy)',
    optWhisperBase:        'base (recommended)',
    optWhisperSmall:       'small',
    optWhisperMedium:      'medium (high accuracy)',
    optWhisperLargeV3:     'large-v3 (best accuracy, GPU required)',
    labelLlamaModel:       'Translation model (LLM)',
    optGroupServerDefault: 'Server default',
    optGroupQwen3:         'Qwen3 (Thinking)',
    optLlamaDefault:       'Use server default',
    optQwen25_3b:          'Qwen2.5 3B (lightweight)',
    optQwen25_7b:          'Qwen2.5 7B (recommended)',
    optQwen25_14b:         'Qwen2.5 14B (accurate, GPU required)',
    optQwen3_0_6b:         'Qwen3 0.6B (lightest)',
    optQwen3_1_7b:         'Qwen3 1.7B',
    optQwen3_4b:           'Qwen3 4B',
    optQwen3_8b:           'Qwen3 8B (recommended)',
    optGemma4_2b:          'Gemma4 2B (lightest)',
    optGemma4_4b:          'Gemma4 4B',
    optGemma4_26b:         'Gemma4 26B (accurate, GPU required)',
    hintLlamaModel:        'If not selected, uses the LLAMA_MODEL set at server startup.',
    labelQwen3Thinking:    'Thinking mode',
    hintQwen3Thinking:     'When enabled, Qwen3 reasons before translating (better accuracy, slower).',
    btnSave:               'Save',
  ...
  ja: {
    ...
    optWhisperTiny:        'tiny（最速・低精度）',
    optWhisperBase:        'base（推奨バランス）',
    optWhisperSmall:       'small',
    optWhisperMedium:      'medium（高精度）',
    optWhisperLargeV3:     'large-v3（最高精度・要GPU）',
    labelLlamaModel:       '翻訳モデル (LLM)',
    optGroupServerDefault: 'サーバーデフォルト',
    optGroupQwen3:         'Qwen3（Thinking 対応）',
    optLlamaDefault:       'サーバーデフォルトを使用',
    optQwen25_3b:          'Qwen2.5 3B（軽量）',
    optQwen25_7b:          'Qwen2.5 7B（推奨）',
    optQwen25_14b:         'Qwen2.5 14B（高精度・要GPU）',
    optQwen3_0_6b:         'Qwen3 0.6B（最軽量）',
    optQwen3_1_7b:         'Qwen3 1.7B',
    optQwen3_4b:           'Qwen3 4B',
    optQwen3_8b:           'Qwen3 8B（推奨）',
    optGemma4_2b:          'Gemma4 2B（超軽量）',
    optGemma4_4b:          'Gemma4 4B',
    optGemma4_26b:         'Gemma4 26B（高精度・要GPU）',
    hintLlamaModel:        '未選択の場合はサーバー起動時の LLAMA_MODEL を使用します。',
    labelQwen3Thinking:    'Thinking モード',
    hintQwen3Thinking:     '有効にすると Qwen3 が推論を展開してから翻訳します（精度向上・低速）。',
    btnSave:               '保存',
